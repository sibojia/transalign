...
int _tmain(int argc, _TCHAR* argv[])
{
	...
	const char* param1 = "ssm=1,auf=audio/L16;rate=16000,vcn=xiaoyan,smk=3";//带参数smk=3，获取详细的语音标注，json格式，请自行解析
	const char* text2  = "讯飞语音，沟通无限。";
	const char*  filename2 = "text_to_speech_test_2.wav";
	const char* param2 = "ssm=1,auf=audio/L16;rate=16000,vcn=xiaoyu";//不带smk参数，获取到的是普通的位置信息
	int ret = 0;
	char key = 0;
